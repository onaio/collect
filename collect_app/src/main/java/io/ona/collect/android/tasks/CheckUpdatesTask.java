...
/**
 * Created by onamacuser on 18/12/2015.
 */
public class CheckUpdatesTask extends Service implements FormListDownloaderListener {
    // constant
    ...
    public void formListDownloadingComplete(HashMap<String, FormDetails> result) {
        ...
        if (result.containsKey(DownloadFormListTask.DL_ERROR_MSG)) {
            ...
            for (int i = 0; i < result.size(); i++) {
                ...
                item.put(NewFormDownloadList.FORMNAME, details.formName);
                item.put(NewFormDownloadList.FORMID_DISPLAY,
                ...
                if (notDismissed && notOlderThan30 &&
                    ...
                    if (mFormList.size() == 0) {
                        ...
                        for (j = 0; j < mFormList.size(); j++) {
                            ...
                            String name = compareMe.get(NewFormDownloadList.FORMNAME);
            ...
            if (updatesAvailable) {
                resultIntent = new Intent(this, NewFormDownloadList.class);
